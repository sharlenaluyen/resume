...
\cvproject{Court Appointed Special Advocate \textit{(current)}} 
\begin{itemize}
...
\cvproject{Citizen's Review Board Member \textit{(current)}} 
\begin{itemize}
    \item {Evaluated family court cases in Multnomah county to provide findings \& recommendations to presiding judge}
\end{itemize} \smallskip

\cvsection{Education}
\cveventedu{B.S. in Computer Science}{Minor in Math, Education, and Leadership}{Oregon State University}{ 2015 --  2019}{GPA: 3.4}
