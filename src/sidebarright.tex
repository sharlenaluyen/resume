...
\hspace{-1em}
\languageadvanced{Typescript, C++, C, Java, Python, SQL, Postgres, LaTex} \hspace{-2em} \languageexperienced{ruby/ruby on rails, HTML, CSS, JavaScript, bash, React, AWS, Jenkins, Travis CI,  Docker} \hspace{-2em} 
\languageproficient{jest, Go, YAML, Haskell, CircleCI, Azure, DataDog}
...
\textit{(2023-current)}}
\begin{itemize}
    \item {Coordinated, planned, \& executed annual fundraiser for over 500 participants, 25 volunteers, \& 150 business donations for silent auction; Raised over \$25k every year}
