...
\hspace{-1em}
\languageadvanced{Typescript, C++, C, Java, Python, SQL, Postgres, LaTex} \hspace{-2em} \languageexperienced{ruby/ruby on rails, HTML/CSS, JavaScript, bash, React, AWS, Jenkins, Docker} \hspace{-2em} 
\languageproficient{jest, Go, YAML, Haskell, CircleCI, Azure}
...
\cvsection{Education}
\cveventedu{B.S. in Computer Science}{Minor in Math, Education, \& Leadership}{Oregon State University}{ 2015 --  2019}{GPA: 3.4}
